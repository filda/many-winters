...
public sealed record SimulationRules
{
    ...
    public float HungerSeekFoodThreshold { get; init; } = 50f;
    ...
    public float IdleSearchRadius { get; init; } = 60f;
    ...
    public float CasualTeachingChancePerTick { get; init; } = 0.05f;
    ...
    // otherwise be.
    public float CasualTeachingChancePerTickForCriticalSkills { get; init; } = 0.3f;
    ...
    public float PersonCollisionRadius { get; init; } = 0.35f;
    ...
    public float MaxCollisionPushPerTick { get; init; } = 1f;
