...
// The hover rim is the case: thousands of sprites, at most one entity hovered (HoverArbiter),
// so a ShaderMaterial per sprite would be thousands for a highlight one of them wears.
    ...
    where T : class
{
    ...
    // back exactly where they stop using it (HoverOutline.Clear, on losing hover).
