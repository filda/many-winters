...
// only the zoom its full-scale terrain needs.
public sealed record PresentationSettings
{
    ...
    public float OcclusionMargin { get; init; } = 0.3f;

    public float OcclusionFadedAlpha { get; init; } = 0.25f;
    ...
    public float OcclusionDistanceTolerance { get; init; } = 2f;
    ...
    public float SelectionMarkerScreenSize { get; init; } = 28f;

    public float SelectionMarkerScreenGap { get; init; } = 6f;
    ...
    public float PersonClickScreenRadius { get; init; } = 32f;
    ...
    public float ApproachDistance { get; init; } = 1.2f;
    ...
    public float MinZoom { get; init; } = 3f;

    public float MaxZoom { get; init; } = 2000f;
}
