...
// Configuration, not state; Default is what the shipped game uses.
public sealed record SimulationPacing
{
    public static SimulationPacing Default { get; } = new();

    public double TickIntervalSeconds { get; init; } = 1.0;
    ...
    public long SelectedPersonIdleGraceTicks { get; init; } = 5;
}
